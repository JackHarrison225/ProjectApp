...
const NavBarNoAuth = () => {
    ...
    return (
        <div className="flex justify-between bg-gunmetal shadow-lg items-center w-full mx-auto p-6">
            ...
            <Link href="/login" className="hidden md:inline-block mr-4 text-white">Sign In</Link>
            <Link href="/signup" className="hidden md:inline-block mr-4 text-white">Sign Up</Link>
